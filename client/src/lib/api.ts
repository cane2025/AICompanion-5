...
// Additional Care Plans API (extended endpoints)
...
// Additional Implementation Plans API (extended endpoints)
...
export const getImplementationPlansByClient = (clientId: string): Promise<any> =>
  fetch(`${API_BASE_URL}/implementation-plans/${clientId}`, {
    credentials: "include",
  }).then((res) => handleResponse<any>(res));
