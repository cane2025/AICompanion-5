...
export function WeeklyDocumentationDialog({
  ...
  const selectedStaffIdValue = form.watch("staffId");
  const { data: clients = [] } = useQuery<Client[]>({
    queryKey: ["/api/staff", selectedStaffIdValue, "clients"],
    queryFn: () => api.getClientsByStaff(selectedStaffIdValue),
    enabled: !!selectedStaffIdValue,
  });
